...
Day.belongsTo(Hotel);
Day.belongsToMany(Restaurant, {through: ' meals'} );
Day.belongsToMany(Activity, {through: 'adventures'});
...
//Bob - commented out below. used "through" above to establish join tables:
// Meal.belongsTo(Day);
